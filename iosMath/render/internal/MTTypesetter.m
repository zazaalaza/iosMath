...
- (CGGlyph) findGlyph:(CGGlyph) glyph withHeight:(CGFloat) height glyphAscent:(CGFloat*) glyphAscent glyphDescent:(CGFloat*) glyphDescent glyphWidth:(CGFloat*) glyphWidth
{
    ...
    CTFontGetBoundingRectsForGlyphs(_styleFont.ctFont, 0.0, glyphs, bboxes, numVariants);
    CTFontGetAdvancesForGlyphs(_styleFont.ctFont, 0.0, glyphs, advances, numVariants);
...
- (MTGlyphConstructionDisplay*) constructGlyph:(CGGlyph) glyph withHeight:(CGFloat) glyphHeight
{
    ...
    CGFloat width = CTFontGetAdvancesForGlyphs(_styleFont.ctFont, 0.0, &first, NULL, 1);
...
- (MTDisplay*) makeLargeOp:(MTLargeOperator*) op
{
    ...
    if (op.nucleus.length == 1) {
        ...
        // vertically center
        CGRect bbox = CTFontGetBoundingRectsForGlyphs(_styleFont.ctFont, 0.0, &glyph, NULL, 1);
        CGFloat width = CTFontGetAdvancesForGlyphs(_styleFont.ctFont, 0.0, &glyph, NULL, 1);
